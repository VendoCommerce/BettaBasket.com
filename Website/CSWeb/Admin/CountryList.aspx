            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td nowrap align="center" width="10%">
                        <asp:HyperLink ID="hlAddState" runat="Server"><img title='Add States' src='//d10yufw89ry03z.cloudfront.net/images/admin/edit.gif' alt="Add States" border="0"></asp:HyperLink>&#160;
                    </td>
                </tr>
            </ItemTemplate>
        </asp:DataList>
